...
class WorkflowNode(object):
    def __init__(self):
        self.variable_list = []  # list(NodeVariable)
        self.generated_variable_list = []  # list(NodeVariable)
    ...
    @classmethod
    def create_from_dict(cls, node_dict: dict):
        node = cls()
    ...
    def get_variable(self, variable_name: str) -> NodeVariable or None:
    ...
    def get_variable_value(self, variable_name: str):
