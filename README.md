...
[![Build Status](https://travis-ci.org/cemc-oper/nwpc-workflow-model.svg?branch=master)](https://travis-ci.org/perillaroc/nwpc-workflow-model)
...
The workflow model using in CEMC/CMA, supports SMS and ecFlow.
...
Copyright &copy; 2016-2020, perillaroc at cemc-oper.
